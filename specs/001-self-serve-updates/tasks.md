...
5. [x] Add dependency-bump version visibility in docs and workflow output (US-009)
...
4. [ ] Workflow logs clearly expose the current and latest `lore-mcp` tags for each run.
